...
public class BolusInfusionRate_Measurement extends Measurement {
	...
	public BolusInfusionRate_Measurement() {
		super();
	}

	public BolusInfusionRate_Measurement(
			BolusInfusionRate_Method_Type desiredInfusionRateType,
	...
	public MeasurementType defineMeasurementType() {
		...
		return MeasurementType.BOLUS_INFUSION_RATE;
	}
