...
public class _Super_Options extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
     ...
     * properties
     */
    private var _internal_option : ArrayCollection;
    ...
    {
        var oldValue:ArrayCollection = _internal_option;
        if (oldValue !== value)
        {
            ...
            {
                _internal_option = new ArrayCollection(value);
            }
            else if (value == null)
            {
                _internal_option = null;
            }
            else
            {
                throw new Error("value of option must be a collection");
            }
    ...
    model_internal function setterListenerOption(value:flash.events.Event):void
    {
        if (value is mx.events.PropertyChangeEvent)
        {
            ...
            {
                mx.events.PropertyChangeEvent(value).newValue.addEventListener(mx.events.CollectionEvent.COLLECTION_CHANGE, model_internal::setterListenerOption);
            }
        }
    ...
    model_internal var _doValidationLastValOfOption : ArrayCollection;
